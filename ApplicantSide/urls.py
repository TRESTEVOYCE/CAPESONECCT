...
from .views import (
    ApplicantPersonalInfoCreateView, ApplicantEducationCreateView, 
    ApplicantPreferredJobCreateView, ApplicantDocumentsCreateView, 
    ApplicantSkillCreateView, ApplicantPersonalUpdateInfoView, 
    ApplicantEducationUpdateView, ApplicantSkillUpdateView, 
    ApplicantPreferredJobUpdateView, ApplicantDocumentsUpdateView, 
    ApplicantProfileDeleteView, LogoutView, DashBoardView, 
    JobListView, JobDetailsView, SortJobView, AppliedJobsListView, 
    SavedJobsListView, SearchJobView
...
urlpatterns = [
    path('', RedirectView.as_view(pattern_name='applicant:dashboard', permanent=False)),
    ...
    path('jobs/<uuid:uuid>/', JobDetailsView.as_view(), name='job_details'),
